...
class VideoBuffi extends Component{
    render(){
        return(
        <><h1 id="titolo" style={{height:"60px",borderRadius:"6px",background:"lightblue",color: "purple", textAlign: "center", marginBottom: 20, paddingTop:"5px"}}>Carrellata di video buffi a tema animale!</h1>
